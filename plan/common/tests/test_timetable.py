...
class TimetableTestCase(BaseTestCase):
    ...
    def test_timetable(self):
        ...
        rows.append(
            [[lecture2, lecture4, last], [lecture9], [lecture10], [last], [last]]
        )
        ...
        rows.append(
            [[lecture2, lecture4, lecture5], [lecture9], [last], [last], [last]]
        )
        ...
        rows.append(
            [[lecture3, lecture4, lecture5], [lecture9], [last], [last], [last]]
        )
