...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.syllabus'
        db.add_column('common_course', 'syllabus', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Course.syllabus'
        db.delete_column('common_course', 'syllabus')
