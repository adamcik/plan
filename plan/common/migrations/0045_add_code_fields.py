...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('common_group', ['name'])

        # Rename existing name field to code.
        db.rename_column('common_group', 'name', 'code')

        # Adding unique constraint on 'Group', fields ['code']
        db.create_unique('common_group', ['code'])

        # Adding field 'LectureType.code'
        db.add_column('common_lecturetype', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True), keep_default=False)

        # Adding field 'Group.name'
        db.add_column('common_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Adding field 'Room.code'
        db.add_column('common_room', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.name'
        db.delete_column('common_group', 'name')

        # Removing unique constraint on 'Group', fields ['code']
        db.delete_unique('common_group', ['code'])

        # Rename existing code field to name.
        db.rename_column('common_group', 'code', 'name')

        # Adding unique constraint on 'Group', fields ['name']
        db.create_unique('common_group', ['name'])

        # Deleting field 'LectureType.code'
        db.delete_column('common_lecturetype', 'code')

        # Deleting field 'Room.code'
        db.delete_column('common_room', 'code')
