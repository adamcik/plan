...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'Exam.exam_type'
        db.add_column('common_exam', 'exam_type', orm['common.exam:exam_type'])
    
    def backwards(self, orm):
        # Deleting field 'Exam.exam_type'
        db.delete_column('common_exam', 'exam_type_id')
