...
class Migration:
    ...
    def forwards(self, orm):
        db.rename_table('common_type', 'common_lecturetype')
        
        # Changing field 'Lecture.type'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['common.LectureType'], null=True, blank=True))
        db.alter_column('common_lecture', 'type_id', orm['common.lecture:type'])
    
    def backwards(self, orm):
        db.rename_table('common_lecturetype', 'common_type')
        
        # Changing field 'Lecture.type'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['common.Type'], null=True, blank=True))
        db.alter_column('common_lecture', 'type_id', orm['common.lecture:type'])
