...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.alter_column('common_exam', 'duration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True))

    def backwards(self, orm):
        db.alter_column('common_exam', 'duration', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))
