...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Semester.active'
        db.add_column('common_semester', 'active', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Semester.active'
        db.delete_column('common_semester', 'active')
