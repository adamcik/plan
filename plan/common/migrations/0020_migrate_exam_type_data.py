...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for exam in orm.Exam.objects.all():
            try:
                exam_type = orm.ExamType.objects.get(code=exam.type)
            except orm.ExamType.DoesNotExist:
                exam_type = orm.ExamType.objects.create(code=exam.type)

            if not exam_type.name:
                exam_type.name = exam.type_name
                exam_type.save()
    ...
    def backwards(self, orm):
        ...
        orm.Exam.objects.all().update(exam_type=None)
        orm.ExamType.objects.all().delete()
    ...
    models = {
        ...
        'common.exam': {
            ...
            'exam_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.ExamType']", 'null': 'True', 'blank': 'True'}),
