...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.last_import'
        db.add_column('common_course', 'last_import', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 1, 12, 0), blank=True), keep_default=False)

        # Adding field 'ExamType.last_import'
        db.add_column('common_examtype', 'last_import', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 1, 12, 0), blank=True), keep_default=False)

        # Adding field 'Lecture.last_import'
        db.add_column('common_lecture', 'last_import', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 1, 12, 0), blank=True), keep_default=False)

        # Adding field 'Room.last_import'
        db.add_column('common_room', 'last_import', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 1, 12, 0), blank=True), keep_default=False)

        # Adding field 'Exam.last_import'
        db.add_column('common_exam', 'last_import', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 1, 12, 0), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.last_import'
        db.delete_column('common_course', 'last_import')

        # Deleting field 'ExamType.last_import'
        db.delete_column('common_examtype', 'last_import')

        # Deleting field 'Lecture.last_import'
        db.delete_column('common_lecture', 'last_import')

        # Deleting field 'Room.last_import'
        db.delete_column('common_room', 'last_import')

        # Deleting field 'Exam.last_import'
        db.delete_column('common_exam', 'last_import')
    ...
    models = {
        ...
        'common.room': {
            'Meta': {'unique_together': "(('code', 'name'),)", 'object_name': 'Room'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_import': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'common.semester': {
            ...
            'active': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
