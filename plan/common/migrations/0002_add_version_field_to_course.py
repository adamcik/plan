...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.version'
        db.add_column('common_course', 'version', orm['common.course:version'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Course.version'
        db.delete_column('common_course', 'version')
