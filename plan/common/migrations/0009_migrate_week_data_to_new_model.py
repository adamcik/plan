...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for week in orm.Week.objects.all():
            for lecture in orm.Lecture.objects.filter(weeks__number=week.number):
                orm.NewWeek(number=week.number, lecture=lecture).save() 
    
    def backwards(self, orm):
        "Write your backwards migration here"
    
        orm.NewWeek.objects.all().delete()
