...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('common_room', ['name'])

        # Adding unique constraint on 'Room', fields ['code', 'name']
        db.create_unique('common_room', ['code', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Room', fields ['code', 'name']
        db.delete_unique('common_room', ['code', 'name'])

        # Adding unique constraint on 'Room', fields ['name']
        db.create_unique('common_room', ['name'])
